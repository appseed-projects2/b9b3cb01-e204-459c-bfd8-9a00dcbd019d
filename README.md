...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-15 07:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b9b3cb01-e204-459c-bfd8-9a00dcbd019d.git
$ cd b9b3cb01-e204-459c-bfd8-9a00dcbd019d
```
